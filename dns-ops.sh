...
base_dir="/etc/named"
server_ipaddr="192.168.1.10"
domain="oradt.com"
#private_file="${base_dir}/Koradt.com.+157+01158.private"
private_file="/var/named/oradt.com.key"
...
function print_help(){
  ...
  echo "Examples:"
  echo "${0} -t A -u add -n ns1 -v 192.168.1.10"
  echo "${0} -t A -u del -n ns1 -v 192.168.1.10"
  echo "${0} -t CNAME -u add -n ns3 -v ns1.oradt.com"
  echo "${0} -t CNAME -u del -n ns3 -v ns1.oradt.com"
  echo "${0} -t PTR -u add -n 192.168.1.10 -v ns1.oradt.com"
  echo "${0} -t PTR -u del -n 192.168.1.10 -v ns1.oradt.com"
  exit 1
}
